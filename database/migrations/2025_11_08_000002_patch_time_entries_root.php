...
return new class extends Migration
{
    ...
    {
        Schema::table('core_time_entries', function (Blueprint $table) {
            ...
            $table->index(['team_id', 'root_context_type', 'root_context_id'], 'time_entries_root_index');
        });
    }
    ...
    {
        Schema::table('core_time_entries', function (Blueprint $table) {
            $table->dropIndex('time_entries_root_index');
