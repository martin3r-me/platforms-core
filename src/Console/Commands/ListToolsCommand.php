...
class ListToolsCommand extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            // Einfach die Registry aus dem Container holen
            // Die Registry wird automatisch mit allen Tools gefüllt (via afterResolving)
            // Module registrieren ihre Tools selbst im ServiceProvider
