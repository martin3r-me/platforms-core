{{--
    Agenda-Content (Header + Kanban/„Mein Tag"). Die Liste/Auswahl liegt im
    Nav-Kind core.terminal.agenda-nav (linke Terminal-Leiste); der Auswahl-State
    kommt via terminal-agenda-state herein. Alpine-Var `fullscreen` erbt aus dem
    Shell-Root-Scope.
--}}
<div class="flex-1 min-h-0 flex flex-col"
  ...
  <div class="relative px-4 flex items-center gap-2.5 border-b border-[var(--t-border)]/60 flex-shrink-0"
    ...
    @elseif($activeAgendaId)
      ...
      @php $currentAgenda = $this->currentAgenda; @endphp
      @if($currentAgenda)
