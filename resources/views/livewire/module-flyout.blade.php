<div x-data="{ moduleFlyoutOpen: false, search: '' }"
    ...
    <template x-teleport="body">
        <div x-show="moduleFlyoutOpen" x-cloak x-transition
            ...
            x-effect="if(moduleFlyoutOpen) { $nextTick(() => { const r = $refs.trigger.getBoundingClientRect(); $el.style.top = (r.bottom + 8) + 'px'; $el.style.right = (window.innerWidth - r.right) + 'px'; const si = $el.querySelector('[x-ref=moduleSearch]'); if(si) si.focus(); }) }"
