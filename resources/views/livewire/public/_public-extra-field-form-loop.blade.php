                                ...
                                @switch($fieldType)
                                    ...
                                    @case('file')
                                        @php
                                            ...
                                            // A4: Upload gesperrt, bis alle Basis-Pflichtfelder befüllt sind.
                                            $lockedUntilBasics = !empty($options['locked_until_basics']);
                                        @endphp
                                        @if($lockedUntilBasics)
                                            <p x-show="!basisComplete()" x-cloak class="mb-2 text-xs text-amber-600 flex items-center gap-1.5">
                                                ...
                                                Bitte zuerst die Basisangaben ausfüllen, dann kannst du hier hochladen.
                                            </p>
                                        @endif
                                        <div @if($lockedUntilBasics) x-bind:class="!basisComplete() ? 'opacity-50 pointer-events-none select-none' : ''" @endif>
